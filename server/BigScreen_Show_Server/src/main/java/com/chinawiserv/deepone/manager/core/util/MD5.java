...
public class MD5 {
	...
	public static void main(String args[]) {
		...
		if (Array.getLength(args) == 0) { // 如果没有参数，执行标准的Test Suite
			...
			m.md5Init();
			System.out.println(m.getMD5ofStr("'四川省南充市蓬安县相如镇建设南路','51292619540808036402','兰碧坤','其他食品零售','11B0CDFA1A44DFC30EC7E503F7BF941C'"));
			m.md5Init();
			System.out.println(m.getMD5ofStr("'四川省南充市蓬安县相如镇建设南路','51292619520302118401','兰碧坤','其他食品零售','11B0CDFA1A44DFC30EC7E503F7BF941C'"));
			//System.out.println("MD5 Test suite:");
			//System.out.println("MD5(\"a@qa\"):" + m.getMD5ofStr("a@qa"));
